...
class EnTamParallelText(tfds.core.GeneratorBasedBuilder):
  ...
  def _split_generators(self, dl_manager):
    ...
    return [
          tfds.core.SplitGenerator(name=tfds.Split.TRAIN, num_shards=6,\
              gen_kwargs={"data_file":os.path.join(extracted_path_train,'en_tam_parallel_corpus_train')}),
          tfds.core.SplitGenerator(name=tfds.Split.VALIDATION, num_shards=4,\
        ...
        #os.path.join(extracted_path, "en_tam_parallel_corpus_validation")}),\
          tfds.core.SplitGenerator(name=tfds.Split.TEST, num_shards=4,\
